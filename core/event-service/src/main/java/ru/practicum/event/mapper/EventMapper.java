...
public class EventMapper {
    ...
    public EventFullDto toFullDto(Event event, UserShortDto userShortDto) {
    ...
    public EventShortDto toShortDto(Event event, UserShortDto dto) {
    ...
    public Event toEntity(NewEventDto newEventDto, Long userId, Category category) {
        Event event = Event.builder()
                ...
                .category(category)
                .initiatorId(userId)
                .location(toEntity(newEventDto.getLocation()))
