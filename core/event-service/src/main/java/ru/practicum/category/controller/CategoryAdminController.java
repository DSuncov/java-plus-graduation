...
public class CategoryAdminController {
    ...
    @PostMapping
    public ResponseEntity<CategoryDto> create(@Valid @RequestBody @NotNull CategoryRequestDto categoryRequestDto) {
    ...
    public ResponseEntity<CategoryDto> update(
            ...
            @Valid @RequestBody @NotNull CategoryRequestDto categoryRequestDto) {
